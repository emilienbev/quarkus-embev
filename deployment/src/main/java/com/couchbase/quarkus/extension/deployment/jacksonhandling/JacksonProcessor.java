...
import com.couchbase.client.core.deps.com.fasterxml.jackson.annotation.SimpleObjectIdResolver;
...
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.ConfigurationCustomizer;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.JacksonBuildTimeConfig;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.JacksonSupport;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.JacksonSupportRecorder;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.MixinsRecorder;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.ObjectMapperProducer;
import com.couchbase.quarkus.extension.runtime.jacksonhandling.runtime.VertxHybridPoolObjectMapperCustomizer;
...
public class JacksonProcessor {
    ...
    private static final DotName JSON_CREATOR = DotName
            .createSimple("com.couchbase.client.core.deps.com.fasterxml.jackson.annotation.JsonCreator");

    private static final DotName JSON_NAMING = DotName
            .createSimple("com.couchbase.client.core.deps.com.fasterxml.jackson.databind.annotation.JsonNaming");

    private static final DotName JSON_IDENTITY_INFO = DotName
            .createSimple("com.couchbase.client.core.deps.com.fasterxml.jackson.annotation.JsonIdentityInfo");

    private static final DotName BUILDER_VOID = DotName.createSimple(Void.class.getName());

    private static final String TIME_MODULE = "com.couchbase.client.core.deps.com.fasterxml.jackson.datatype.jsr310.JavaTimeModule";

    private static final String JDK8_MODULE = "com.couchbase.client.core.deps.com.fasterxml.jackson.datatype.jdk8.Jdk8Module";

    private static final String PARAMETER_NAMES_MODULE = "com.couchbase.client.core.deps.com.fasterxml.jackson.module.paramnames.ParameterNamesModule";
    ...
    void register(
        ...
        reflectiveClass.produce(
                ReflectiveClassBuildItem.builder(
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.ser.std.SqlDateSerializer",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.ser.std.SqlTimeSerializer",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.deser.std.DateDeserializers$SqlDateDeserializer",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.deser.std.DateDeserializers$TimestampDeserializer",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.annotation.SimpleObjectIdResolver")
                        .reason(getClass().getName())
                        .methods().build());
        reflectiveClass.produce(
                ReflectiveClassBuildItem.builder(
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.ser.std.ClassSerializer",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.ext.CoreXMLSerializers",
                        "com.couchbase.client.core.deps.com.fasterxml.jackson.databind.ext.CoreXMLDeserializers")
                        .reason(getClass().getName())
                        .constructors()
                        .build());

        if (curateOutcomeBuildItem.getApplicationModel().getDependencies().stream().anyMatch(
                x -> x.getGroupId().equals("com.couchbase.client.core.deps.com.fasterxml.jackson.module")
                        && x.getArtifactId().equals("jackson-module-jaxb-annotations"))) {
            reflectiveClass.produce(
                    ReflectiveClassBuildItem.builder(
                            "com.couchbase.client.core.deps.com.fasterxml.jackson.module.jaxb.JaxbAnnotationIntrospector")
                            .reason(getClass().getName())
                            .methods().build());
        }
    ...
    void generateCustomizer(BuildProducer<GeneratedBeanBuildItem> generatedBeans,
        ...
        try (ClassCreator classCreator = ClassCreator.builder().classOutput(classOutput)
                .className(
                        "com.couchbase.quarkus.extension.runtime.jacksonhandling.customizer.RegisterSerializersAndDeserializersCustomizer")
